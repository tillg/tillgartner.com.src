...
**mgm Vietnam - Tech** [Network bandwidth](http://52.77.106.30:5601/app/kibana#/dashboard?_g=(refreshInterval:(display:Off,pause:!f,value:0),time:(from:now-24h,mode:quick,to:now))&_a=(filters:!(),options:(darkTheme:!f),panels:!((col:1,id:Download-bandwidth,panelIndex:1,row:1,size_x:12,size_y:4,type:visualization),(col:1,id:uploadbandwidth,panelIndex:2,row:5,size_x:12,size_y:6,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:'New%20Dashboard',uiState:())) - [Gerrit](https://mgmgerrit.mgm-tp.com/#/admin/projects/)
